...
\documentclass[
  color,         % remove for less green, or specify color with e.g. 'color=tuorange'
...
% tu and faculty logo on top of the titlepage
\titlehead{\mbox{\hspace{-1cm}\includegraphics[height=1.5cm]{logos/tu.pdf}\hspace{.5cm}\raisebox{-0.15cm}{\includegraphics[height=1.5cm]{logos/fakultaet.pdf}}}}
